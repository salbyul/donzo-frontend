    ...
    return (
        <>
            ...
            <div className="mt-5 mb-5">
                ...
                <details>
                    <summary
                        className="rounded-md bg-[#719E71] px-1 py-1 transition duration-700 hover:bg-gray-400 space-x-1 text-white mt-5 mb-3 hover:cursor-pointer"
                        align="center"
                    >
                        추가 작성 1
                    </summary>
                ...
                <details>
                    <summary
                        className="rounded-md bg-[#719E71] px-1 py-1 transition duration-700 hover:bg-gray-400 space-x-1 text-white mt-1 hover:cursor-pointer"
                        align="center"
                    >
                        추가 작성 2
                    </summary>
