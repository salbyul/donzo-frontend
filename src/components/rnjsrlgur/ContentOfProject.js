    ...
    return (
        <>
            <div className="w-700 mt-0 m-auto">
                <span className="w-full mt-12 block text-slate-900 break-all text-3xl mb-12 font-semibold tracking-wider">
                    {subtitle}
                </span>
                <span className="w-full block mt-4 m-auto leading-7 text-slate-700 whitespace-pre-line break-all text-xl tracking-wide">
                    <p>{content}</p>
                </span>
                <img
